...
function generateName() {
    const firstNames = ["Alex", "Bailey", "Casey", "Dylan", "Elliott", "Finley", "Grayson", "Harper", "Ivy", "Jordan", "Kai", "Logan", "Morgan", "Nico", "Oakley", "Peyton", "Quinn", "Riley", "Sawyer", "Taylor", "Umi", "Vivian", "Wyatt", "Xen", "Yael", "Zane"];
...
console.log('mention-dummy', dummy);
